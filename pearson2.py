...
# Set window properties to control figure size
cv2.namedWindow('before', cv2.WINDOW_NORMAL)
cv2.resizeWindow('before', 240, 520)

cv2.namedWindow('after', cv2.WINDOW_NORMAL)
cv2.resizeWindow('after', 240, 520)

cv2.namedWindow('mask', cv2.WINDOW_NORMAL)
cv2.resizeWindow('mask', 240, 520)

cv2.namedWindow('filled after', cv2.WINDOW_NORMAL)
cv2.resizeWindow('filled after', 240, 520)
...
for c in contours:
    ...
    if area > 40:
        ...
        cv2.drawContours(filled_after, [c], 0, (48, 25, 52), -1)
